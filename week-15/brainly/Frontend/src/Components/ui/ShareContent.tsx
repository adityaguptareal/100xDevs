...
const ShareContent: React.FC<ShareContentProps> = ({ link, open, onClose }) => {
    ...
    return (
        ...
        >
            <div
                className="relative rounded-md shadow-2xl p-7 w-full max-w-md mx-4 animate-fadeIn"
                style={{
            ...
            >
                ...
                <div className="flex flex-col gap-4">
                    <div
                        className="flex items-center bg-gray-50 rounded-sm px-3 py-2 border"
                        style={{
                    ...
                    >
                        ...
                        <button
                            className="ml-auto flex items-center gap-1 px-3 py-1.5  font-medium transition"
                            style={{
                    ...
                    <div className="flex flex-col gap-3 mt-2">
                        {shareOptions.map((option) => (
                            <button
                                key={option.name}
                                className="flex items-center gap-3 px-4 py-3 rounded-full transition font-semibold text-base"
                                style={{
